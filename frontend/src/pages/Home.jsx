    ...
    <main data-testid="home-page">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-5 md:px-12">
          ...
          >
            <span
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white shadow-sm border border-slate-200 text-[11px] md:text-xs font-medium text-slate-700"
            ...
            <h1 className="font-display mt-5 md:mt-7 text-4xl sm:text-5xl md:text-6xl lg:text-7xl tracking-tight font-light text-slate-900 text-balance max-w-4xl leading-[1.05]">
              The Builders of{" "}
              <span className="ka-gradient-text italic font-medium">
                Next Generation
              </span>
            </h1>
            <p className="mt-4 md:mt-6 max-w-2xl text-base md:text-lg text-slate-600 leading-relaxed px-2">
              Empowering students with academic excellence, career guidance and
              personal mentorship — at Kaizen Academy, Thrithala, learning is
              crafted, not delivered.
            </p>
            <div className="mt-7 md:mt-9 flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
              <Link
                to="/courses"
                className="group w-full sm:w-auto inline-flex justify-center items-center gap-2 px-6 md:px-7 py-3 md:py-3.5 rounded-full bg-slate-900 text-white text-sm font-medium hover:bg-slate-800 hover:-translate-y-0.5 transition-all shadow-[0_10px_30px_rgba(15,23,42,0.18)]"
              ...
              <Link
                to="/contact#enquiry"
                className="w-full sm:w-auto inline-flex justify-center items-center gap-2 px-6 md:px-7 py-3 md:py-3.5 rounded-full ka-gradient text-white text-sm font-medium hover:-translate-y-0.5 transition-all shadow-[0_10px_30px_rgba(124,58,237,0.35)]"
            ...
            <div className="mt-9 md:mt-12 flex flex-wrap items-center justify-center gap-2">
              {[
                ...
                <span
                  key={t}
                  className="px-3 py-1.5 text-[11px] md:text-xs rounded-full bg-white/70 backdrop-blur border border-slate-200 text-slate-700"
                >
                  {t}
                </span>
              ))}
          ...
          <motion.div
            ...
            className="relative mt-14 md:mt-24 mx-auto max-w-5xl"
          >
            <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-slate-200 rounded-2xl md:rounded-3xl overflow-hidden shadow-[0_30px_80px_-30px_rgba(15,23,42,0.25)]">
              {STATS.map((s, i) => (
                <div
                  key={i}
                  className="bg-white p-4 md:p-8 text-center"
                  data-testid={`stat-${i}`}
                >
                  <div className="font-display text-3xl md:text-5xl font-light text-slate-900">
                    <AnimatedCounter value={s.value} suffix={s.suffix} />
                  </div>
                  <div className="mt-1.5 md:mt-2 text-[10px] md:text-xs tracking-[0.2em] uppercase text-slate-500">
                    {s.label}
                  </div>
                </div>
              ))}
      ...
      <Section className="bg-white">
        <div className="max-w-7xl mx-auto px-5 md:px-12 grid lg:grid-cols-12 gap-10 md:gap-12 items-start">
          ...
          >
            ...
            <h2 className="font-display mt-4 md:mt-5 text-3xl sm:text-4xl md:text-5xl font-light text-slate-900 tracking-tight text-balance">
              A premium learning experience designed in Thrithala.
            </h2>
            <p className="mt-5 md:mt-6 text-sm md:text-base text-slate-600 leading-relaxed">
              Kaizen Academy nurtures students through personalised coaching,
              innovative teaching and career-oriented education. We don't run
              another tuition centre — we craft learners who think, lead and
              excel.
            </p>
            <Link
              to="/about"
              className="mt-7 inline-flex items-center gap-2 text-sm font-medium text-slate-900 group"
            ...
            {WHY_FEATURES.map((f, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-5 font-display text-xl text-slate-900">
                    {f.title}
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <div>
              ...
              <h2 className="font-display mt-4 text-4xl sm:text-5xl font-light tracking-tight text-slate-900">
                Coaching that meets ambition.
              </h2>
            </div>
            <Link
              to="/courses"
              className="inline-flex items-center gap-2 text-sm font-medium text-slate-900 group"
              data-testid="courses-all-link"
            >
              View all programs{" "}
              <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
            </Link>
          ...
          <div className="mt-10 md:mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
            {COURSE_CATEGORIES.map((c, i) => {
              ...
              return (
                ...
                >
                  <div
                    className="absolute top-0 right-0 h-32 w-32 rounded-full opacity-10 blur-2xl"
                    style={{ background: c.accent }}
                  />
                  <div
                    className="inline-flex items-center justify-center h-12 w-12 rounded-2xl text-white shadow-md"
                    style={{ background: c.accent }}
                  >
                    <Icon className="h-5 w-5" />
                  </div>
                  <div className="mt-6 font-display text-2xl text-slate-900">
                    {c.label}
                  </div>
                  <p className="mt-2 text-sm text-slate-600 leading-relaxed">
                    {c.blurb}
                  ...
                  <ul className="mt-5 flex flex-wrap gap-1.5">
                    {c.courses.slice(0, 4).map((cc) => (
                      <li
                        key={cc}
                        className="text-[11px] px-2.5 py-1 rounded-full bg-slate-100 text-slate-700"
                      >
                        {cc}
                      </li>
                    ))}
                    {c.courses.length > 4 && (
                      <li className="text-[11px] px-2.5 py-1 rounded-full bg-slate-100 text-slate-700">
                        +{c.courses.length - 4}
                      </li>
                    )}
                  </ul>
                  <Link
                    to="/courses"
                    className="mt-6 inline-flex items-center gap-1 text-sm font-medium text-slate-900 group/cta"
      ...
      <Section className="bg-white">
        <div className="max-w-7xl mx-auto px-5 md:px-12">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <h2 className="font-display mt-3 md:mt-4 text-3xl sm:text-4xl md:text-5xl font-light tracking-tight text-slate-900">
              Learn in a positive environment.
            </h2>
            <p className="mt-3 md:mt-4 text-sm md:text-base text-slate-600">
              A calm, well-lit, distraction-free campus engineered for deep
              focus.
            </p>
          </div>
          ...
          <div className="mt-12 flex justify-center">
            <Link
              to="/gallery"
              className="group inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-slate-900 text-white text-sm font-medium hover:bg-slate-800 hover:-translate-y-0.5 transition-all shadow-[0_10px_30px_rgba(15,23,42,0.18)]"
              data-testid="campus-view-all-btn"
            >
              View All Photos{" "}
              <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
            </Link>
      ...
      {/* WHY CHOOSE US */}
      <Section
        className="bg-[#0B1220] text-white relative overflow-hidden"
        id="why"
      >
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] rounded-full opacity-20 blur-3xl ka-gradient" />
        <div className="relative max-w-7xl mx-auto px-5 md:px-12">
          <div className="max-w-2xl">
            <div className="text-[10px] md:text-[11px] tracking-[0.3em] uppercase text-slate-400 font-semibold">
              Why Students Choose Us
            </div>
            <h2 className="font-display mt-4 md:mt-5 text-3xl sm:text-4xl md:text-5xl font-light tracking-tight">
              A coaching ecosystem built around{" "}
              <em className="ka-gradient-text not-italic">you</em>.
            </h2>
          </div>
          <div className="mt-10 md:mt-14 grid grid-cols-2 md:grid-cols-3 gap-px bg-white/10 rounded-2xl md:rounded-3xl overflow-hidden">
            {WHY_CHOOSE.map((f, i) => {
              ...
              return (
                <div
                  key={f.title}
                  className="bg-[#0B1220] p-5 md:p-9 hover:bg-white/[0.03] transition-colors group"
                  data-testid={`whychoose-${i}`}
                >
      ...
      <Section className="bg-white">
        <div className="max-w-7xl mx-auto px-5 md:px-12 grid lg:grid-cols-12 gap-10 md:gap-12 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="lg:col-span-5 mx-auto w-full max-w-sm md:max-w-md lg:max-w-none"
          >
            <div className="relative">
              ...
              <div className="relative aspect-[4/5] rounded-3xl overflow-hidden bg-slate-100">
                <img
                  src={ASSETS.founder}
                  alt="Founder, Kaizen Academy"
                  className="w-full h-full object-cover"
                  data-testid="founder-img"
                />
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="mt-3 md:mt-4 font-display text-2xl sm:text-3xl md:text-4xl text-slate-900 leading-snug text-balance font-light">
              "At Kaizen Academy, our mission is to shape confident learners and
              future leaders through quality education and continuous
              improvement."
            </p>
            <div className="mt-8 flex items-center gap-4">
              <div className="h-px flex-1 bg-slate-200" />
              <div>
                <div className="font-display text-xl italic text-slate-900">
                  Suhail
                </div>
                <div className="text-xs tracking-[0.2em] uppercase text-slate-500">
                  Founder, Kaizen Academy, Thrithala
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <Section className="bg-[#FAFAFA]">
        ...
        <div className="mt-10 md:mt-14 max-w-3xl mx-auto px-5 md:px-6">
          <motion.div
            ...
            className="glass rounded-2xl md:rounded-3xl p-6 md:p-10 shadow-[0_30px_80px_-40px_rgba(15,23,42,0.3)]"
          ...
          >
            ...
            <p className="mt-4 md:mt-5 font-display text-xl sm:text-2xl md:text-3xl font-light text-slate-900 leading-snug">
          ...
          <div className="mt-6 flex items-center justify-center gap-2">
            {TESTIMONIALS.map((_, i) => (
              <button
                key={i}
                onClick={() => setTIndex(i)}
                className={`h-1.5 rounded-full transition-all ${i === tIndex ? "w-8 bg-slate-900" : "w-1.5 bg-slate-300"}`}
      ...
      <Section className="bg-white">
        <div className="max-w-7xl mx-auto px-5 md:px-12">
          <div className="max-w-2xl">
            ...
            <h2 className="font-display mt-3 md:mt-4 text-3xl sm:text-4xl md:text-5xl font-light tracking-tight text-slate-900">
              Connect with Kaizen Academy.
            </h2>
            <p className="mt-3 md:mt-4 text-sm md:text-base text-slate-600">
              Latest classes, achievements, success stories and educational
              content — straight from our campus.
            </p>
          </div>
            ...
            {[
              {
                ...
                bg: "bg-gradient-to-tr from-rose-500 via-fuchsia-500 to-amber-400",
                items: [
                  "Latest Updates",
                  "Educational Reels",
                  "Student Activities",
              ...
              },
              {
                ...
                bg: "bg-red-600",
                items: ["Learning Videos", "Career Guidance", "Exam Prep Tips"],
                cta: "Subscribe",
              },
              {
                id: "facebook",
                ...
                bg: "bg-blue-600",
                items: ["Community Updates", "Announcements", "Events"],
                cta: "Follow",
              },
            ].map((s, i) => (
              <motion.a
              ...
              >
                ...
                />
                <div
                  className={`inline-flex h-12 w-12 rounded-2xl items-center justify-center ${s.bg} shadow-md`}
                >
                  {s.icon}
                </div>
                <div className="mt-6 font-display text-2xl text-slate-900">
      ...
      <section className="relative overflow-hidden" data-testid="admission-cta">
        ...
        <div
          className="absolute -bottom-20 right-0 h-96 w-96 rounded-full bg-rose-300/30 blur-3xl animate-float"
          style={{ animationDelay: "2s" }}
        />
        <div className="relative max-w-5xl mx-auto px-5 md:px-12 py-16 md:py-32 text-center text-white">
          <div className="text-[10px] md:text-[11px] tracking-[0.3em] uppercase font-semibold opacity-90">
            Now Enrolling
          </div>
          <h2 className="font-display mt-4 md:mt-5 text-4xl sm:text-5xl md:text-6xl font-light tracking-tight">
            Admissions Open Now
          </h2>
          <p className="mt-4 md:mt-5 max-w-2xl mx-auto text-sm md:text-base text-white/85 leading-relaxed">
            Join Kaizen Academy and build a strong foundation for your future.
            Limited seats. Big outcomes.
          </p>
          <div className="mt-7 md:mt-9 flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              to="/contact#enquiry"
              className="w-full sm:w-auto inline-flex justify-center items-center gap-2 px-6 md:px-7 py-3 md:py-3.5 rounded-full bg-white text-slate-900 text-sm font-medium hover:-translate-y-0.5 transition-transform shadow-xl"
            ...
            <a
              ...
              className="w-full sm:w-auto inline-flex justify-center items-center gap-2 px-6 md:px-7 py-3 md:py-3.5 rounded-full bg-white/10 border border-white/40 text-white text-sm font-medium hover:bg-white/15 transition-colors backdrop-blur"
