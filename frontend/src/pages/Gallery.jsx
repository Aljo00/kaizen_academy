    ...
    <main data-testid="gallery-page" className="pt-28 md:pt-32">
      <section className="max-w-7xl mx-auto px-5 md:px-12 pb-8 md:pb-10">
        ...
        <p className="mt-5 md:mt-6 max-w-2xl text-base md:text-lg text-slate-600 leading-relaxed">
          Classrooms, achievements, ceremonies and quiet corners — moments from
          our campus in Thrithala.
        </p>
      ...
      <AnimatePresence>
        {idx !== null && (
          ...
          >
            ...
            <button
              onClick={prev}
              className="absolute left-3 md:left-8 h-12 w-12 rounded-full bg-white/10 hover:bg-white/20 text-white flex items-center justify-center"
            ...
            <button
              onClick={next}
              className="absolute right-3 md:right-8 h-12 w-12 rounded-full bg-white/10 hover:bg-white/20 text-white flex items-center justify-center"
